...
public class DBService {
    ...
    @Autowired
    private PessoaRepository pessoaRepository; //No código apresentado, a anotação "@Autowired" é usada para injetar
...
//    private ClienteRepository clienteRepository;
    ...
    public void instanciaDB() {
        Tecnico tec1 = new Tecnico(null, "Luan Braz", "550.482.150-95", "luan@mail.com", "123");
